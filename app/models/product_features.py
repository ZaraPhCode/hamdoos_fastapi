...
class TechnicalFeature(Base, BaseEntityMixin):
    ...
    display_format: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    priority: Mapped[int] = mapped_column(Integer, default=0)
    linear_display: Mapped[bool] = mapped_column(Boolean, default=False)
    d_value: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
